      ...
      <div class="container">
        ...
        <div class="nav-collapse collapse">
          <ul class="nav nav-pills pull-right">
                    ...
                    <li  class="active"><a href="index_9E9F9BE8.php" title="Info Perpustakaan">Info Perpustakaan</a></li>
  ...
  <div class="container">
    <div class="row">
      <!--// Check For No Query //-->
        ...
        <div class="span8">
                    <div class="tagline">
                        Library Information                        <a href="javascript: history.back();" class="btn btn-mini btn-danger pull-right"><i class="icon icon-white icon-circle-arrow-left"></i> Kembali </a>
          </div>
          
          
                                    <div class="page"><h3>Contact Information</h3>
<p class="heading">PERPUSTAKAAN</p>
<p><span style="font-family: mceinline;">FAKULTAS ILMU SOSIAL DAN ILMU POLITIK</span></p>
<p><span style="font-family: mceinline;">UNIVERSITAS DIPONEGORO</span></p>
<p><strong>Alamat :</strong> <br /> Jl. Prof. Soedarto, SH Tembalang Semarang<br /> <strong>Telepon :</strong> <br /> (024) 7465407&nbsp;<br /> <strong>Faksimili :</strong> <br /> (024) 7465405</p>
<p><strong><strong>Email</strong> :</strong>&nbsp;<br />fisip[at]undip[dot]ac[dot]id</p>
<p>&nbsp;</p>
<h3>Waktu Pelayanan</h3>
<p><strong>Senin - Kamis :</strong> <br /> Buka: 07.30 WIB<br />Istirahat : 12.00 - 13.00 WIB<br /> Tutup : 16.00 WIB<br /> <strong>Jumat :</strong> <br />Buka: 07.30 WIB<br />Istirahat : 11.30 - 13.00 WIB<br />Tutup : 16.30 WIB</p>
<h3></h3></div>
