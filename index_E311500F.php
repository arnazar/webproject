      ...
      <div class="container">
        ...
        <div class="nav-collapse collapse">
          <ul class="nav nav-pills pull-right">
                    ...
                    <li  class="active"><a href="index_E311500F.php" title="Area Anggota">Area Anggota</a></li>
...
<div class="content">
  <div class="container">
    ...
    <div class="loginInfo">
    <form action="index_E311500F.php" method="post">
        ...
        <div class="span4">
          <!--// If Member Logged //-->
            ...
            <div class="tagline">
              Informasi            </div>
            <div class="info">
              Selamat Datang di Area Anggota, dimana Anda bisa melihat status keanggotaan dan peminjaman Anda            </div>
          </div>
                    <!--// End Member Logged //-->
          <br/>
